void showContent(){
        ...
        image(arduino, width*0.1, height*0.7);
        ...
        text("當更多資訊人看見這個當初為了設計與藝術創作者所開發的工具後，開發了更多有趣的輔助工具，可以讓創作者更方便的將現實世界的資訊，加入虛擬世界的創作，我們可以敲擊桌子，很快的傳到電腦畫面中，讓我們所創作的動畫根據節奏來變化 by MAO", width*0.29, height*0.762, width*0.2, height*0.18);
        text("http://www.openframeworks.cc", width*0.61, height*0.31);
        text("可以快速的將已經創作好的程式應用到不同的平台上，自從開始支援行動裝置之後，以前用OF創作的作品都能搬移到行動裝置上，仿佛獲得重生 by 江振維", width*0.54, height*0.34, width*0.2, height*0.12);
        text("除了平台部屬快速，運作效能極佳之外，OF讓許多有想法的科技人，可以用自己再熟悉不過的C語言，創作出屬於自己的數位藝術作品！ by 林繼鴻", width*0.54, height*0.465, width*0.2, height*0.12);
        text("http://reprap.org", width*0.163, height*0.39);
        text("http://fritzing.org", width*0.29, height*0.47);
        text("http://www.gimp.org", width*0.3, height*0.62);
        text("http://www.blender.org", width*0.765, height*0.08);
        text("http://inkscape.org", width*0.58, height*0.78);
}
